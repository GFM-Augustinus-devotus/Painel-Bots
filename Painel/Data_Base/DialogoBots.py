...
class DialogoBots(Base):
    ...
    pergunta13      = Column(quoted_name("Pergunta 13", True), String)
    pergunta14      = Column(quoted_name("Pergunta 14", True), String)
    pergunta15      = Column(quoted_name("Pergunta 15", True), String)
    pergunta16      = Column(quoted_name("Pergunta 16", True), String)
    pergunta17      = Column(quoted_name("Pergunta 17", True), String)
    pergunta18      = Column(quoted_name("Pergunta 18", True), String)
    pergunta19      = Column(quoted_name("Pergunta 19", True), String)
    pergunta20      = Column(quoted_name("Pergunta 20", True), String)
    pergunta21      = Column(quoted_name("Pergunta 21", True), String)
    pergunta22      = Column(quoted_name("Pergunta 22", True), String)
